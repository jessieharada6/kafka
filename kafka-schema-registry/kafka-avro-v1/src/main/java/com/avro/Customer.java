...
// import this class from target using the same name space, otherwise it will result in error of
// Could not find class com.example.Customer specified in writer's schema whilst finding reader's schema for
// at Consumer
