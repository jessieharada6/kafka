package com.kafka.schema.registry.avro.generic;
...
public class GenericRecordExamples {
    public static void main(String[] args) {
        ...
        // second customer with default of automated_email
        // if we didn't set the default value, we must provide a value - if not will lead to AvroRuntime exception
        ...
        GenericData.Record customerWithDefault = null;
        try {
            customerWithDefault = customerBuilderWithDefault.build();
        ...
        try (DataFileReader<GenericRecord> dataFileReader = new DataFileReader<>(file, datumReader)){
            ...
            // read a non-existent field -> throw an error
